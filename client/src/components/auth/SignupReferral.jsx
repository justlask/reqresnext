...
import HasAccount from './Referral/HasAccount'
import NoAccount from './Referral/NoAccount'

// needs to go to functional/hooks
const SignupReferral = (props) => {
  const service = new AuthService();
  return (props.match.params.hasAccount === "true") ? <HasAccount params={props.match.params}/> : <NoAccount  params={props.match.params}/>
}
